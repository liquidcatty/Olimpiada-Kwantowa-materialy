...
Rozdział obejmuje podstawowe algorytmy kwantowe: problemy wyroczni (Deutsch, Deutsch–Jozsa,
Bernstein–Vazirani, Simon), transformatę Fouriera (QFT), estymację fazy, algorytm Grovera
i algorytm Shora. Omawia model obwodowy, wyrocznię i złożoność zapytań, kick-back fazy oraz
amplitudowe wzmacnianie (amplitude amplification).

Mechanizm przyspieszenia pokazano na trzech poziomach: Deutscha (1 zapytanie zamiast 2), Grovera
(przyspieszenie kwadratowe) i Shora (wykładnicze, dzięki QFT); przyspieszenie uzyskuje się przez
interferencję wzmacniającą amplitudy odpowiedzi przed pomiarem. Rozdział wiąże się z teorią
informacji (07), splątaniem (09) i algorytmami zaawansowanymi (19).
...
**Obwód**: $\mathrm{QFT}_2=\mathrm{SWAP}\cdot(I\otimes H)\cdot \mathrm{CS}\cdot(H\otimes I)$,
...
QFT nie daje żadnej informacji „za darmo” — to jednostkowa zmiana bazy.
...
**Rachunek.** Start: $\lvert s\rangle=\tfrac12(\lvert00\rangle+\lvert01\rangle+\lvert10\rangle+\lvert11\rangle) =\tfrac12(1,1,1,1)^\mathsf{T}$.
